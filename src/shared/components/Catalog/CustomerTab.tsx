  ...
  return (
    <div className="surface rounded-xl p-5 animate-fade-in">
      ...
      {customers.length === 0 ? (
        ...
        <div
          data-tutorial="customers-list"
          className="space-y-2 max-h-[50vh] sm:max-h-80 overflow-y-auto"
        >
      ...
      {importResult && (
        <div className="mt-2 text-xs text-center text-emerald-400 animate-fade-in">
          {importResult}
        </div>
      )}
