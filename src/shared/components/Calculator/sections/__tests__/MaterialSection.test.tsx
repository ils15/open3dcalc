...
describe("MaterialSection", () => {
    ...
    render(
      <MaterialSection
        ...
        isFieldVisible={vi.fn(
          (_section: string, field: string) => field === "purgeWeight",
        )}
      />,
    );
  ...
  it("shows spool efficiency input when isFieldVisible returns true", () => {
    ...
    render(
      <MaterialSection
        ...
        isFDM={true}
        isFieldVisible={vi.fn(
          (_section: string, field: string) => field === "spoolEfficiency",
        )}
      />,
    );
  ...
  it("shows density input when isFieldVisible returns true", () => {
    ...
    render(
      <MaterialSection
        ...
        isFDM={true}
        isFieldVisible={vi.fn(
          (_section: string, field: string) => field === "density",
        )}
      />,
    );
  ...
  it("shows waste margin input when isFieldVisible returns true for resin", () => {
    ...
    render(
      <MaterialSection
        ...
        isFDM={false}
        isFieldVisible={vi.fn(
          (_section: string, field: string) => field === "wasteMargin",
        )}
      />,
    );
  ...
  it("renders without crashing with empty catalogMaterials", () => {
    const store = createMockStore();
    render(
      <MaterialSection {...defaultProps} store={store} catalogMaterials={[]} />,
    );
    expect(screen.getByTestId("section-header")).toBeInTheDocument();
  });
  ...
  it("renders without crashing with empty inventorySpools", () => {
    const store = createMockStore();
    render(
      <MaterialSection {...defaultProps} store={store} inventorySpools={[]} />,
    );
    expect(screen.getByTestId("section-header")).toBeInTheDocument();
  });
