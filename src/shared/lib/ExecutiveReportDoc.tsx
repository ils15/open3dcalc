      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.table}>
            ...
            <View style={styles.tableRow}>
              ...
              >
                {formatMoney(comparison.revenue.current)}
              </Text>
              <Text
                style={[styles.tableCellRight, { width: COL_PREVIOUS }]}
              >
                {formatMoney(comparison.revenue.previous)}
              </Text>
              <Text
                style={[
            ...
            <View style={[styles.tableRow, styles.tableRowAlt]}>
              ...
              <Text
                style={[styles.tableCellRight, { width: COL_CURRENT }]}
              >
                {formatMoney(comparison.cost.current)}
              </Text>
              <Text
                style={[styles.tableCellRight, { width: COL_PREVIOUS }]}
              >
                {formatMoney(comparison.cost.previous)}
              </Text>
              <Text
                style={[
            ...
            <View style={styles.tableRow}>
              ...
              <Text
                style={[styles.tableCellRight, { width: COL_CURRENT }]}
              >
                {formatMoney(comparison.profit.current)}
              </Text>
              <Text
                style={[styles.tableCellRight, { width: COL_PREVIOUS }]}
              >
                {formatMoney(comparison.profit.previous)}
              </Text>
              <Text
                style={[
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>
            Generated by Open3DCalc on {new Date().toLocaleDateString('pt-BR')}
