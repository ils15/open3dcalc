...
<p>The block is two fields: the slicer subscription and the STL file, each with its own math.</p>
<ul>
...
field</strong> as the <a href="#user-content-machine-costs">machine</a> section:</p>
...
<p>Two fields, one of money and one of information: PPE enters the price, and carbon does not.</p>
<ul>
...
<p>And the carbon footprint, with the default intensity of 100 g/kWh and a 250 W
printer:</p>
<pre><code>energyKwh = (250 / 1000) * 5.5 = 1.375 kWh
...
<a href="#user-content-material">material</a> cost — which was R$ 16.20 (0.18 kg of PLA
at R$ 90/kg).</p>
<h2 id="user-content-how-this-section-relates-to-the-others">How this section relates to the others</h2>
<p>The section's boundaries, kept so the subscription and the supplies do not land in the wrong place.</p>
<ul>
<li>The <strong>hours per month</strong> prorating the subscription are the workshop's productive
hours. They need not match the <a href="#user-content-machine-costs">machine's</a> usage
...
<a href="#user-content-print-parameters">print parameters</a>.</li>
<li>The <strong>finishing supplies</strong> (sandpaper, paint) live in
<a href="#user-content-hardware-wear">hardware wear</a>; here belong the safety and cleaning
supplies.</li>
...
<p>Four common mistakes across these two blocks, and all of them leave a real cost out of the price.</p>
<ol>
