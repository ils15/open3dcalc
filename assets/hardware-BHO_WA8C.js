...
<p>The nozzle is prorated by the part's weight, and two fields are enough to close the math.</p>
<ul>
...
<p>One field only, fixed per part, because adhesive wears with every print rather than by the hour.</p>
<ul>
...
<p>One field for what you spent on sandpaper, primer and paint on this specific part.</p>
<ul>
...
<p>The section connects to five others, and each boundary prevents a duplicated cost.</p>
<ul>
...
<a href="#user-content-print-parameters">print parameters</a> section.</li>
<li>Depreciation of the <strong>whole</strong> printer (the asset, not its parts) lives in the
<a href="#user-content-machine-costs">machine</a> section. Hardware is the part that wears;
...
<p>Four common filling errors, and all of them leave the wear out of the price.</p>
<ol>
...
the <a href="#user-content-machine-costs">machine</a> section. Only consumable parts belong
here.</li>
