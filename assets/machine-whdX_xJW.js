...
<p>Each piece of the hourly rate comes from somewhere, and the boundaries keep the machine from being charged twice.</p>
<ul>
...
<p>Four errors in the hourly rate, and all of them make the part cheaper than it costs.</p>
<ol>
