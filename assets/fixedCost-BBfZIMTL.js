...
a mesma ideia do campo <a href="#user-content-custos-da-m%C3%A1quina">uso mensal</a>. Se este campo
...
horária da máquina</strong>, na seção <a href="#user-content-custos-da-m%C3%A1quina">máquina</a>. Assim, o
...
<pre><code>aluguel + condomínio     = R$ 350
internet                 = R$ 60
...
<p>A peça carrega <strong>R$ 16,50</strong> de aluguel, internet e energia base. Compare com os
R$ 16,20 de <a href="#user-content-material">material</a> (0,18 kg de PLA a R$ 90/kg): a peça
paga mais aluguel do que filamento. É esse o momento em que muita gente descobre
que o preço de venda estava cobrando só o plástico.</p>
...
<pre><code>150 h/mês → 450 / 150 = R$ 3,00/h
...
<p>Estas são as fronteiras da seção, para você não somar duas vezes o que já está em outro lugar.</p>
<ul>
<li>O rateio é aplicado na taxa horária da <a href="#user-content-custos-da-m%C3%A1quina">máquina</a>,
junto com a depreciação e a manutenção.</li>
<li>As horas produtivas da oficina não precisam ser iguais às horas de uso da
<a href="#user-content-custos-da-m%C3%A1quina">máquina</a>. O rateio divide o custo fixo pelas
...
<a href="#user-content-par%C3%A2metros-de-impress%C3%A3o">parâmetros</a>; não a duplique aqui.</li>
<li>A <strong>manutenção do equipamento</strong> fica na <a href="#user-content-custos-da-m%C3%A1quina">máquina</a>;
aqui fica a manutenção do <strong>espaço</strong>.</li>
</ul>
<h2 id="user-content-armadilhas-práticas">Armadilhas práticas</h2>
<p>Quatro erros aparecem com frequência nesta seção, e todos eles barateiam o preço sem ninguém perceber.</p>
<ol>
