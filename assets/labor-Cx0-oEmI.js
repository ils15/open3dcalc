...
another paid job. Print time is charged by the <a href="#user-content-machine-costs">machine</a>
...
<p>The section is three fields: two clock your work and one says what it is worth.</p>
<ul>
...
<a href="#user-content-fixed-costs">fixed costs</a> and <a href="#user-content-machine-costs">machine</a>
...
<p>The boundaries matter, because the time and the material of finishing live in different sections.</p>
<ul>
<li>The <strong>print time</strong> (which is NOT here) comes from
<a href="#user-content-print-parameters">print parameters</a> and feeds
<a href="#user-content-machine-costs">machine</a>.</li>
<li>The <strong>supplies</strong> for post-processing — sandpaper, paint, acetone — live in
<a href="#user-content-hardware-wear">hardware wear</a>, in the finishing block. Only the
time belongs here; the material belongs there.</li>
<li>The <strong>share and depreciation</strong> are in <a href="#user-content-machine-costs">machine</a> and
<a href="#user-content-fixed-costs">fixed costs</a>, and are multiplied by print hours,
...
<p>Four mistakes surround this section, and each one gives away a piece of your time.</p>
<ol>
