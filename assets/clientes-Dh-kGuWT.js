var e=`clientes`,t=`pt-BR`,n={title:`Clientes`,order:22},r=[{depth:1,text:`Clientes`,slug:`user-content-clientes`},{depth:2,text:`O cadastro`,slug:`user-content-o-cadastro`},{depth:2,text:`Por que manter aqui`,slug:`user-content-por-que-manter-aqui`},{depth:2,text:`Vinculando a um orçamento`,slug:`user-content-vinculando-a-um-orçamento`},{depth:2,text:`Acompanhando o histórico`,slug:`user-content-acompanhando-o-histórico`},{depth:2,text:`Importar e exportar`,slug:`user-content-importar-e-exportar`},{depth:2,text:`Armadilhas comuns`,slug:`user-content-armadilhas-comuns`},{depth:2,text:`Exemplo: o que o histórico revela`,slug:`user-content-exemplo-o-que-o-histórico-revela`}],i=`<h1 id="user-content-clientes">Clientes</h1>
...
<p>Quatro erros de cadastro, e cada um deles enfraquece o histórico sem fazer barulho.</p>
<ul>
<li><strong>Deixar o cliente de fora do orçamento.</strong> Sem vínculo, a proposta some no meio da lista e
ninguém consegue responder "quanto já propus para este cliente?". O cadastro existe para o
seletor existir.</li>
<li><strong>Cadastrar a mesma pessoa duas vezes.</strong> Sem a empresa, dois "João" ficam soltos; o contador
de orçamentos se divide entre as cópias e o histórico perde a força. A empresa existe para
separar nomes iguais.</li>
<li><strong>Esperar que a edição do cadastro reescreva o orçamento enviado.</strong> O vínculo aponta para o
cadastro atual, mas o texto do documento é uma cópia congelada. Corrigir o e-mail hoje não
muda o que o cliente recebeu ontem.</li>
<li><strong>Apagar o cliente para limpar a lista.</strong> A exclusão pede confirmação porque os orçamentos
vinculados continuam existindo, só perdem o vínculo. Em vez de apagar, use a busca.</li>
</ul>
