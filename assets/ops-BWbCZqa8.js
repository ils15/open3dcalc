...
<p>O bloco são dois campos: a mensalidade do slicer e o arquivo STL, cada um com uma matemática própria.</p>
<ul>
...
<p>Dois campos, um de dinheiro e outro de informação: o EPI entra no preço, o carbono não.</p>
<ul>
...
<p>As fronteiras da seção, para a mensalidade e os insumos não pararem no lugar errado.</p>
<ul>
...
<p>Quatro erros nestes dois blocos, e todos eles deixam um custo real fora do preço.</p>
<ol>
