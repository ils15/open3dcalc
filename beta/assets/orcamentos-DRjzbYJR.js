...
<p>Quatro erros acontecem na montagem do documento, e todos eles se descobrem depois de enviado.</p>
<ul>
<li><strong>Digitar o preço de cabeça.</strong> O preço unitário é editável, e ajustar R$ 42,70 para R$ 45,00
é correto quando foi o acordado. Mas quem digita um preço sem estimativa por trás perde o
rastro do custo — o item vem do Histórico justamente para o preço nascer de um cálculo.</li>
<li><strong>Esquecer que os descontos se acumulam.</strong> Um desconto na linha e outro global se somam, e
o app mostra o total em dinheiro. Quem olha só as porcentagens subestima o tamanho do
abatimento antes de enviar.</li>
<li><strong>Recalcular a peça e esperar o orçamento acompanhar.</strong> O orçamento é uma fotografia:
preços, dados do cliente e condições congelam no salvamento. Se o filamento subir, a
estimativa nova sai mais cara e o documento continua dizendo o que foi combinado.</li>
<li><strong>Excluir rascunhos para reorganizar a numeração.</strong> A sequência é automática e contínua, e
não há buraco quando você exclui um — aquele número nunca é reaproveitado. A confirmação
da exclusão existe por isso.</li>
</ul>
<h2 id="user-content-exemplo-de-ponta-a-ponta">Exemplo de ponta a ponta</h2>
<p>Um exemplo real mostra o caminho: da primeira estimativa ao documento aprovado, com todos os números.</p>
<ol>
