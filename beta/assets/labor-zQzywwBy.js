...
<a href="#user-content-machine">máquina</a> (depreciação, energia, rateio), não por aqui.</p>
...
<a href="#user-content-fixedCost">custos fixos</a> e <a href="#user-content-machine">máquina</a>) e
...
<a href="#user-content-print">parâmetros</a> e alimenta <a href="#user-content-machine">máquina</a>.</li>
<li>Os <strong>insumos</strong> do pós-processamento — lixa, tinta, acetona — moram em
<a href="#user-content-hardware">desgaste de hardware</a>, bloco de acabamento. Aqui
fica só o tempo; lá fica o material.</li>
<li>O <strong>rateio e a depreciação</strong> estão em <a href="#user-content-machine">máquina</a> e
<a href="#user-content-fixedCost">custos fixos</a>, e são multiplicados pelas horas de
impressão, não pelas suas horas.</li>
<li>O lucro por hora exibido em <a href="#user-content-results">resultados</a> usa
...
<a href="#user-content-results">resultado</a> ainda cobre o acabamento individual.</li>
