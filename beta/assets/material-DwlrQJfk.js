...
<p>Na impressão por filamento, os campos básicos são:</p>
<ul>
...
<p>A peça que percorre os outros artigos — o suporte de celular — é o caso mais
simples: <strong>180 g de PLA a R$ 90/kg</strong>, sem torre de purga:</p>
<pre><code>custo material = (180 / 1000) * 90 = 0,18 * 90 = R$ 16,20
</code></pre>
<p>É esse <strong>R$ 16,20</strong> que os artigos de <a href="#user-content-custos-fixos">custos fixos</a>
e <a href="#user-content-operacional--software">operacional &#x26; software</a> citam ao
comparar com o próprio custo.</p>
...
fixa. Veja detalhes no artigo sobre o <a href="#user-content-invent%C3%A1rio">inventário</a>.</p>
<h2 id="user-content-armadilhas-comuns">Armadilhas comuns</h2>
<p>Quatro erros clássicos desta seção, e todos eles fazem o material parecer mais barato do que é.</p>
<ul>
