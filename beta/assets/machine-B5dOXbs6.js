...
FEP. Veja <a href="#user-content-hardware">hardware</a>.</li>
</ul>
...
<p>O <code>rateioFixo</code> vem da seção <a href="#user-content-fixedCost">custos fixos</a> e é
...
<a href="#user-content-fixedCost">custos fixos</a> é a que mais separa hobby de negócio.</p>
...
<a href="#user-content-print">parâmetros</a>, não o tempo de mão de obra.</li>
<li>O <strong>rateio</strong> que entra na taxa vem de
<a href="#user-content-fixedCost">custos fixos</a>.</li>
<li>As <strong>partes</strong> gastas (bico, mesa) estão em <a href="#user-content-hardware">hardware</a>
e são somadas à parte.</li>
<li>A depreciação entra no bloco "Equipamento &#x26; Desgaste" do
<a href="#user-content-results">resultado</a>.</li>
</ul>
