...
<p>Four misreadings of this screen, and all of them lead to a decision made with the wrong number.</p>
<ul>
<li><strong>Expecting the dashboard to show revenue.</strong> It reads no quotes and queries no external
system: it only sums the estimates from History plus the open one. An approved quote does
not show up here until it becomes a saved estimate.</li>
<li><strong>Reading the average margin as profit over revenue.</strong> Each estimate computes its own first;
the mean of 57.8%, 39.7% and 85.0% is 60.8%, but it is not total profit divided by revenue.
A cheap part with a high margin moves the number as much as an expensive one.</li>
<li><strong>Assuming the empty screen is a bug.</strong> "No history data" is the normal state for someone
who just installed the app — save three estimates and the screen fills in. No setting is
missing.</li>
<li><strong>Ignoring the low margin alert.</strong> A part sold for R$ 25.00 at a R$ 21.00 cost has a 16%
