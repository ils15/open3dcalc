...
See <a href="#user-content-hardware">hardware</a>.</li>
</ul>
...
<p>The <code>fixedShare</code> comes from the <a href="#user-content-fixedCost">fixed costs</a> section
...
<a href="#user-content-fixedCost">fixed costs</a> section is what most separates a hobby
from a business.</p>
...
<a href="#user-content-print">print parameters</a> section, not the labor time.</li>
<li>The <strong>share</strong> entering the rate comes from
<a href="#user-content-fixedCost">fixed costs</a>.</li>
<li>The worn <strong>parts</strong> (nozzle, bed) live in <a href="#user-content-hardware">hardware</a>
