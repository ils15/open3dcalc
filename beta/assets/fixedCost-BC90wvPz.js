...
month, the same idea as the <a href="#user-content-machine">monthly usage</a> field. If
...
<strong>machine's hourly rate</strong>, in the <a href="#user-content-machine">machine</a> section. That
...
<pre><code>rent + building fees   = R$ 450
internet                = R$ 60
...
<p>The part carries <strong>R$ 20.18</strong> of rent, internet and baseline power. Compare it
to the R$ 16.20 of <a href="#user-content-material">material</a>: the part pays more rent
than filament. That is the moment many people discover their selling price was
only covering plastic.</p>
...
<pre><code>150 h/month → 550 / 150 = R$ 3.67/h
...
<ul>
<li>The share is applied inside the <a href="#user-content-machine">machine</a> hourly rate,
alongside depreciation and maintenance.</li>
<li>The hours you use here must be <strong>the same</strong> as the machine's monthly usage.
Using 150 h here and 300 h there is self-deception: the share comes out halved.</li>
<li>The <strong>printing energy</strong> (unlike baseline power) is counted in the
<a href="#user-content-print">print parameters</a> section; do not duplicate it here.</li>
<li><strong>Equipment maintenance</strong> belongs to <a href="#user-content-machine">machine</a>; here
