...
<p>Ele está espalhado em duas abas, lado a lado no app:</p>
<ul>
<li><strong>Filamentos</strong>: os rolos de filamento que você tem na prateleira.</li>
<li><strong>Cadastros</strong>: impressoras, materiais e marketplaces usados como presets.</li>
</ul>
<p>Cada campo dessas abas é lido por uma seção específica da calculadora. Se um
...
<h2 id="user-content-a-aba-filamentos">A aba Filamentos</h2>
<p>Cada entrada é um <strong>rolo</strong> físico, com os campos:</p>
<ul>
<li><strong>Marca</strong> e <strong>material</strong> (PLA, PETG, ABS, TPU, ASA, SILK...).</li>
<li><strong>Cor</strong> e a cor em hexa, para diferenciar rolos parecidos.</li>
<li><strong>Peso restante</strong> e <strong>peso original</strong>, em gramas.</li>
...
<p>A lista filtra por material e por status, então você acha rápido o rolo certo
antes de começar uma impressão.</p>
...
<li>valor da impressora e vida útil → seção <a href="#user-content-hardware">Hardware</a></li>
<li>potência e manutenção por hora → seção <a href="#user-content-machine">Machine</a></li>
<li>taxas e frete do marketplace → seção <code>sales</code></li>
</ul>
...
<p>O <strong>peso restante</strong> é o que torna o inventário útil no dia a dia. Ele anda
junto com a calculadora: a peça ativa e a quantidade atual definem quanto
plástico a impressão vai consumir, e cada rolo responde se dá conta:</p>
