...
<a href="#user-content-machine">máquina</a>. Hardware é a parte que se gasta; máquina é
o todo que se deprecia.</li>
<li>O <strong>tempo</strong> que você gasta lixando e pintando é cobrado à parte, em
<a href="#user-content-labor">mão de obra</a> — aqui ficam só os insumos.</li>
<li>O resultado de tudo isto é somado em <a href="#user-content-results">resultados</a>.</li>
</ul>
...
seção <a href="#user-content-machine">máquina</a>. Aqui entram só as partes
consumíveis.</li>
