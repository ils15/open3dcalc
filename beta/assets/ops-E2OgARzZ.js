...
campo de horas</strong> da seção <a href="#user-content-machine">máquina</a>:</p>
...
<a href="#user-content-labor">mão de obra</a> e <a href="#user-content-results">resultados</a>.</p>
...
de 150 W:</p>
<pre><code>energiaKwh = (150 / 1000) * 5,5 = 0,825 kWh
...
custo do <a href="#user-content-material">material</a> — que era R$ 16,20.</p>
<h2 id="user-content-como-esta-seção-se-relaciona-com-as-demais">Como esta seção se relaciona com as demais</h2>
<ul>
<li>As <strong>horas por mês</strong> que rateiam a mensalidade são as mesmas da
<a href="#user-content-machine">máquina</a> — use números iguais, senão o rateio sai
errado.</li>
<li>O <strong>tempo de impressão</strong> que multiplica a taxa vem de
<a href="#user-content-print">parâmetros</a>.</li>
<li>Os <strong>insumos do acabamento</strong> (lixa, tinta) moram em
<a href="#user-content-hardware">desgaste de hardware</a>; aqui ficam os insumos de
segurança e limpeza.</li>
<li>O resultado é somado no bloco "Operacional &#x26; Trabalho" de
<a href="#user-content-results">resultados</a>.</li>
</ul>
