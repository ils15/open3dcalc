var e=`dashboard`,t=`pt-BR`,n={title:`Dashboard`,order:23,tourId:`dashboard-kpis`},r=[{depth:1,text:`Dashboard`,slug:`user-content-dashboard`},{depth:2,text:`KPIs da estimativa ativa`,slug:`user-content-kpis-da-estimativa-ativa`},{depth:2,text:`KPIs do histórico`,slug:`user-content-kpis-do-histórico`},{depth:3,text:`Filtros de período`,slug:`user-content-filtros-de-período`},{depth:2,text:`Gráficos`,slug:`user-content-gráficos`},{depth:2,text:`Metas e alertas`,slug:`user-content-metas-e-alertas`},{depth:2,text:`Exportar o relatório`,slug:`user-content-exportar-o-relatório`},{depth:2,text:`Começando do zero`,slug:`user-content-começando-do-zero`}],i=`<h1 id="user-content-dashboard">Dashboard</h1>
