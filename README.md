...
| família         | citado (antigo)  | real (commit base)                 | medido em `26cc674`                   |
| --------------- | ---------------- | ---------------------------------- | ------------------------------------- |
